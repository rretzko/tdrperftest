                                ...
                                <div class="col-md-8">
                                    <div class="flex text-xl my-4" >
                                        ...
                                        <div class="justify-self-center w-full">
                                            ...
                                            <div style="text-align: center; font-size: 1rem;">Student Application - Page 1/2</div>
                                        </div>
                                    </div>
                                    ...
                                    {{-- AUDITION FEE --}}
                                    <div style="display: flex; justify-content: center; margin-bottom: .5rem; font-weight: bold; font-size: .8rem;">
                                        <div style="align-self: end;">THE AUDITION FEE IS: ${{ number_format($eventversion->eventversionconfigs->registrationfee,2) }}</div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="italic justify-self-stretch mx-4 mb-4" >
                                            We recommend <b>{{ $registrant->student->person->fullName }}</b> for participation in the {{ $eventversion->name }}. <b>{{ $registrant->student->person->first_name }}</b> is a qualified candidate in good
                                            ...
                                            is to be a current (paid) member of the National Association for Music Educators (NAfME), will be present
                                            at the 8:00 AM Director's Meeting at either the SOUTH or NORTH audition to fulfill their first
                                            responsibility for submitting students for auditions and will serve as a FINAL ROOM JUDGE for both
                                            auditions at least every FOUR years.
                                            <b>SOUTH and NORTH auditions could run until 5:00 p.m. and teachers/sponsors are expected to remain
                                                until their audition assignment has been completed, having worked around conflicts including School
                                                Musicals, their rehearsals and performances.</b>
                                            We will review this application to ensure that all parts are complete and accurate.  This application
                                            will be mailed to the audition chairperson postmarked by the application deadline of <b>October 24th, 2021</b>.
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="flex flex-col italic justify-self-stretch mx-4 mb-4">
                                            ...
                                            <ul class="ml-8 list-disc">
                                                ...
                                                <li>
                                                    I understand that I will be housed as required, for the rehearsal and concert dates stated, by
                                                    the NJMEA staff and may not commute or stay in accommodations other than those provided by the
                                                    NJMEA during that time.
                                                </li>
                                                <li>
                                                    I will adhere to all dates concerning fees/forms or any other deadlines requested for my participation.
                                                </li>
                                                <li>
                                                    I understand that all housing and participation fees are 100% non-refundable.  The fee due date
                                                    will appear in the acceptance letter which will arrive after the auditions.
                                                </li>
                                                <li>
